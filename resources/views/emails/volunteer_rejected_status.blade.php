...
<head>
    <meta charset="UTF-8">
    <title>ABVHPS Volunteer Application Status Update</title>
</head>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f9fafb; margin: 0; padding: 24px; color: #374151;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e5e7eb; padding: 28px;">
        ...
        <p style="font-size: 14px; line-height: 1.6; color: #374151;">
            This is an update regarding your application to serve as an ABVHPS Volunteer.
        </p>
        ...
        <div style="margin: 20px 0; padding: 16px; background-color: #fff7ed; border-left: 4px solid #ea580c; border-radius: 4px;">
            ...
            <p style="margin: 4px 0; font-size: 13px; color: #374151;"><strong>Current Status:</strong> Not Approved</p>
        ...
        <p style="font-size: 14px; line-height: 1.6; color: #374151;">
            After administrative review, your Volunteer application has not been approved at this time.
        </p>

        <p style="font-size: 14px; line-height: 1.6; color: #374151;">
            This decision relates only to your Volunteer application and does not affect your ABVHPS Membership status.
        </p>

        <p style="font-size: 14px; line-height: 1.6; color: #374151;">
            If you require clarification regarding this decision, contact the organization separately at:
        </p>

        <p style="font-size: 14px; margin: 8px 0; color: #ea580c; font-weight: bold;">
            info@abvhps.org
        </p>
